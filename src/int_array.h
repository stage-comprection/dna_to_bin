...
namespace int_array {
    ...
    void benchmark(std::ifstream& f1, std::ifstream& f2){
        ...
        const uint8_t s = getReadSize(f1);
        uint8_t s2 = s + s%4;
